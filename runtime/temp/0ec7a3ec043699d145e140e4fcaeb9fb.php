<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/mobile/new2/goods\goodsInfo.html";i:1518006557;s:41:"./template/mobile/new2/public\header.html";i:1509725414;s:42:"./template/mobile/new2/public\top_nav.html";i:1509725414;s:43:"./template/mobile/new2/public\wx_share.html";i:1509725414;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<!--底部按钮-s-->
    ...
    <div class="cart-concert-btm p">
        <div class="fl">
            <ul>
                <li>
                    <!--<a href="tencent://message/?uin=<?php echo $tpshop_config['shop_info_qq']; ?>&Site=家家共享商城&Menu=yes">-->
        ...
        <div class="shop-top-under p">
            <div class="maleri30">
                ...
                <?php if(empty($goods['flash_sale']) || (($goods['flash_sale'] instanceof \think\Collection || $goods['flash_sale'] instanceof \think\Paginator ) && $goods['flash_sale']->isEmpty())): if($filter_spec != ''): if(is_array($filter_spec) || $filter_spec instanceof \think\Collection || $filter_spec instanceof \think\Paginator): if( count($filter_spec)==0 ) : echo "" ;else: foreach($filter_spec as $key=>$spec): ?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; endif; endif; if(!(empty($prefecture_ids) || (($prefecture_ids instanceof \think\Collection || $prefecture_ids instanceof \think\Paginator ) && $prefecture_ids->isEmpty()))): ?>
                    <div class="shulges p choicsel" >
                        <p>商品专区</p>
                        <?php if(is_array($prefecture_ids) || $prefecture_ids instanceof \think\Collection || $prefecture_ids instanceof \think\Paginator): if( count($prefecture_ids)==0 ) : echo "" ;else: foreach($prefecture_ids as $k=>$v): ?>
                            <div class="plus choic-sel">
                                <input type="radio" style="display: none" name="prefecture_id" value="<?php echo $v[id]; ?>"  <?php if($prefecture_id == $v[id]): ?>checked="checked"<?php endif; ?>/>
                                <a href="javascript:;" title="<?php echo $v[name]; ?>" onclick="switch_spec(this);" <?php if($prefecture_id == $v[id]): ?> class="red"<?php endif; ?> ><?php echo $v[name]; ?></a>
                            </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                <?php endif; ?>
...
$(document).ready(function(){
        ...
        $('#buy_goods_form .choicsel').each(function() {
            // 先默认每组的第一个单选按钮添加样式
            if( <?php echo $prefecture_id; ?> > 0 ){
                if(!$(this).find('input[name=prefecture_id]').length){
