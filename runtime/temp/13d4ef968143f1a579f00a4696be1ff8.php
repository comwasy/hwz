<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./template/mobile/new2/goods\package.html";i:1516902207;s:41:"./template/mobile/new2/public\header.html";i:1509725414;s:42:"./template/mobile/new2/public\top_nav.html";i:1509725414;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    <title>套餐专区--<?php echo $tpshop_config['shop_info_store_title']; ?></title>
    ...
    <nav class="storenav p search_list_dump" id="head_search_box product_sort">
        <ul>
            ...
            <li class="<?php if(I('sort') == 'sales_sum'): ?>red<?php endif; ?>">
                <a href="<?php echo urldecode(U('Mobile/Goods/package',array_merge($filter_param,array('sort'=>'sales_sum')),''));?>" >
                    <span class="dq" >销量</span>
                </a>
            </li>
            <li class="<?php if(I('sort') == 'shop_price'): ?>red<?php endif; ?>">
                <a href="<?php echo urldecode(U('Mobile/Goods/package',array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>$sort_asc)),''));?>">
    ...
    <div id="goods_list">
        ...
        <?php else: if(is_array($goods_list) || $goods_list instanceof \think\Collection || $goods_list instanceof \think\Paginator): if( count($goods_list)==0 ) : echo "" ;else: foreach($goods_list as $k=>$vo): ?>
            <div class="orderlistshpop p">
                <div class="maleri30">
                    <a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$vo[goods_id],'prefecture_id'=>2)); ?>" class="item">
        ...
        <div class="maleri30">
            <ul>
                <li class="<?php if(I('sort') == ''): ?>red<?php endif; ?>">
                    <a href="<?php echo urldecode(U('Mobile/Goods/package',array_merge($filter_param,array('sort'=>'')),''));?>" >综合</a>
                </li>
                <li class="<?php if(I('sort') == 'is_new'): ?>red<?php endif; ?>">
                    <a href="<?php echo urldecode(U('Mobile/Goods/package',array_merge($filter_param,array('sort'=>'is_new')),''));?>" >新品</a>
                </li>
                <li class="<?php if(I('sort') == 'comment_count'): ?>red<?php endif; ?>">
                    <a href="<?php echo urldecode(U('Mobile/Goods/package',array_merge($filter_param,array('sort'=>'comment_count')),''));?>">评价</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="list-se-all ma-to-20 two-related">
            ...
            <?php if(is_array($cateArr) || $cateArr instanceof \think\Collection || $cateArr instanceof \think\Paginator): if( count($cateArr)==0 ) : echo "" ;else: foreach($cateArr as $catek=>$cate): ?>
                    <div class="myorder p catearr">
                        <div class="content30">
                            <a href="<?php echo U('Mobile/Goods/package',array('id'=>$cate['id'])); ?>">
                                <div class="order">
                                    <div class="fl">
                ...
                <?php if(is_array($cate[sub_menu]) || $cate[sub_menu] instanceof \think\Collection || $cate[sub_menu] instanceof \think\Paginator): if( count($cate[sub_menu])==0 ) : echo "" ;else: foreach($cate[sub_menu] as $catek2=>$cate2): ?>
                    <div class="myorder p catearr">
                        <div class="content30">
                            <a href="<?php echo U('Mobile/Goods/package',array('id'=>$cate2['id'])); ?>">
                                <div class="order">
                                    <div class="fl">
...
<script type="text/javascript">
        ...
        function submitMoreFilter(t)
        {
            ...
            location.href ="/index.php?m=Mobile&c=Goods&a=package"+url;
        }
        ...
        $('.suce_ok').click(function(){
            ...
            if($('.suce_ok').is('.two')) {
                ...
                location.href= "/index.php?m=Mobile&c=Goods&a=package"+url+"&sel="+sel;
            }
        })
    ...
    function ajax_sourch_submit()
    {
        ...
        $.ajax({
            type : "POST",
            url:"<?php echo U('Mobile/Goods/package'); ?>",//+tab,
